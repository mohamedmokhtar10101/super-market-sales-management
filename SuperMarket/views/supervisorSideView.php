...
<aside id="sidebar">
                    <nav id="nav">
                        ...
                        <ul id="navMenu">
                         ...
                         <li class="navElement"><a class="btn btn-primary <?php echo $classes['controllers/viewOrders_c'] ?>" style="<?php echo $active['controllers/viewOrders_c'] ?> " href="?page=controllers/viewOrders_c#content">Edit and Delete Orders </a></li>
                        </ul>
