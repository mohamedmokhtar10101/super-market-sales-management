        ...
        <tbody>
            ...
            for ($i = 0; $i < $ordersCount; $i++) {
                ...
                echo "
                    ...
                    <td>
                       <a title ='delete this order' class='action' id='deleteAction' style='cursor:pointer' data-id='{$orders[$i]["id"]}' onclick='displayConfirmModal(event,\"viewOrders_c\")'><img src='{$site}delete.png'/></a>
                        <a title='edit this order' class='action' id='editAction' href='?page=controllers/viewOrders_c&action=edit&id={$orders[$i]["id"]}'><img src='{$site}edit.png'></a>
